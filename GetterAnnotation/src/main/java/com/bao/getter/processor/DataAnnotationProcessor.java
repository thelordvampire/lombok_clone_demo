...
public class DataAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element element : roundEnv.getElementsAnnotatedWith(MySetter.class)) {
    ...
    private JCTree.JCMethodDecl createSetter(JCTree.JCVariableDecl field) {
        ...
        System.out.println("11: " + param.sym);
        System.out.println("22: " + field.sym);
        System.out.println("33: " + field.sym.adr); 
        System.out.println("44: " + param.sym.adr);
